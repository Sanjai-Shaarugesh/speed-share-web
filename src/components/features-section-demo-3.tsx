...
export default function FeaturesSectionDemo() {
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <section id='features'><h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Packed with thousands of features
        </h4></section>
        

        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          show and scan QR to connect to te send or receiver to share the file or use the code 🔗 share multiple files at same time 🗃️
        </p>
      </div>
