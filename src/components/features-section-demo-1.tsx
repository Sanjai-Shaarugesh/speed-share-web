...
export default function FeaturesSectionDemo() {
  return (
    <div className="py-12 sm:py-16 md:py-20 lg:py-40 px-4 sm:px-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 max-w-7xl mx-auto">
        {grid.map((feature) => (
          <div
            key={feature.title}
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mt-4 text-sm sm:text-base relative z-20">
              {feature.description}
            </p>
          </div>
        ))}
